# Estudio de usabilidad — Protocolo de sesión (40 min)

> Sesión individual de pensamiento en voz alta + cuestionario SUS
> (Brooke 1996) adaptado al español latinoamericano + 3 preguntas
> abiertas. Planificado para TP3/TP4 con n=8-15.
...
- [ ] Carpeta de destino para grabación verificada (carpeta privada fuera del repo).
- [ ] Nombre de archivo definido siguiendo el patrón `usability-PXX-YYYY-MM-DD`.
...
| 7-10 | Instrucciones de pensamiento en voz alta | Explicar que verbalice todo: dudas, expectativas, confusión, decisiones. |
...
## Instrucciones de pensamiento en voz alta
Leer casi textual:
...
- Señales de carga cognitiva: silencios largos, suspira, relee, vuelve atrás, dice "no entiendo", "no sé".
- Reacciones afectivas relevantes: sorpresa, risa, incomodidad, alivio, frustración.
...
- Si hay silencio: recordar pensamiento en voz alta.
...
Pregunta adicional sobre español latinoamericano:

4. ¿El español de la app se sintió natural? ¿Qué cambiarías del lenguaje o del tono?
...
- Centros de Salud Mental Comunitaria de cada jurisdicción.
...
- [ ] Mover la grabación a la carpeta privada fuera del repo.
