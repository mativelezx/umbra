...
export function ReflectionArt({ variant = 'mirror', className, reveal = false }: ReflectionArtProps) {
  return (
    <SvgArtwork className={cn('reflection-art text-text-1', `art-${variant}`, reveal && 'reflection-reveal', className)}>
      {variant === 'mirror' ? (
        <svg viewBox="0 0 180 200" fill="none" aria-hidden="true" focusable="false" className="h-auto w-full">
          ...
          <g className="art-held-page">
            <path d="m108 99 42-9 13 67-43 10-12-68Z" fill="var(--art-paper, #f7f7f4)" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
            <path className="art-writing" d="m120 112 23-5m-21 15 23-5m-20 15 17-4" stroke="currentColor" strokeWidth="2" />
          </g>
        ...
        <svg viewBox="0 0 160 160" fill="none" aria-hidden="true" focusable="false" className="h-auto w-full">
          {variant === 'dialogue' && <>
            ...
            <path className="art-writing" d="M77 61v75M29 69c12 0 23 3 34 8M29 83c12 0 23 3 34 8M29 97c8 0 16 2 24 5M89 96l29-8m-29 21 22-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            <g className="art-pen">
          ...
          {variant === 'pages' && <>
            <path className="art-back-page" d="m53 14 78 15-21 111-78-15L53 14Z" fill="currentColor" />
            ...
            <path className="art-writing" d="M40 72h63M40 83h63M40 94h42M40 119h54M40 130h33" stroke="currentColor" strokeWidth="2" />
            ...
            <path className="art-confirm" d="m114 120 3 6 9-6" stroke="var(--art-paper, #f7f7f4)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </>}
          {variant === 'steps' && <>
            <g className="art-sun">
            ...
            <path className="art-arm" d="m76 76-15 19-15 3m39-24 13 12 14-7" stroke="currentColor" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
            <path className="art-leg-first" d="m77 102-12 23-18 8" stroke="currentColor" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
            <path className="art-leg-second" d="m91 101 3 18 16 12" stroke="currentColor" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
