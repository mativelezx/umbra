    ...
    <div aria-hidden="true" className={cn('reflection-art text-text-1', reveal && 'reflection-reveal', className)}>
      {variant === 'mirror' ? (
        <svg viewBox="0 0 480 540" fill="none" aria-hidden="true" focusable="false" className="h-auto w-full">
          ...
          <path d="M125 401V196a123 123 0 0 1 246 0v205H125Z" fill="#f7f7f4" />
          <path d="M143 385V199a105 105 0 0 1 210 0v186" stroke="currentColor" strokeWidth="1.5" />
          <circle cx="248" cy="248" r="89" fill="#f7f7f4" stroke="currentColor" strokeWidth="1.5" />
        ...
        <svg viewBox="0 0 160 160" fill="none" aria-hidden="true" focusable="false" className="h-auto w-full">
          {variant === 'dialogue' && <>
            ...
            <path d="M54 130V84a42 42 0 0 1 84 0v46H54Z" fill="#f7f7f4" stroke="currentColor" strokeWidth="2" />
          ...
          {variant === 'pages' && <>
            ...
            <path d="M25 34h82v108H25z" fill="#f7f7f4" stroke="currentColor" strokeWidth="2" />
          ...
          {variant === 'steps' && <>
            ...
            <path d="M37 112h22M74 82h22M111 52h22" stroke="#f7f7f4" strokeWidth="2" />
          </>}
        </svg>
      )}
    </div>
