# Rúbrica de validación del corpus rioplatense propio
...
- Voz introspectiva en voseo argentino (rioplatense).
...
### Criterio 2 — Vocabulario rioplatense
El texto incluye al menos tres marcadores léxicos o sintácticos
rioplatenses entre: vocabulario local ("laburo", "pibe", "boludo",
...
sudamericano si la introspección suena natural a un hablante rioplatense.
...
Riesgos): el corpus rioplatense propio etiqueta una dimensión por caso
...
dominio rioplatense; se compensa con el corpus Essays (n~2500, scores
