  ...
  return (
    <main className="relative mx-auto max-w-3xl px-6 py-16 md:px-10">
      ...
      <article className="prose prose-invert mt-10 space-y-8 font-body leading-relaxed text-text-2">
        <section>
          <h2 className="font-display text-2xl text-text-1">Qué es Umbra</h2>
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Lo que no es</h2>
          <p className="mt-2 text-pretty">
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Sin garantías</h2>
          <p className="mt-2 text-pretty">
