...
export default function PrivacyPage() {
  return (
    <main className="relative mx-auto max-w-3xl px-6 py-16 md:px-10">
      ...
      <h1 className="mt-6 text-balance font-display text-5xl italic text-text-1 md:text-6xl">
        Política de privacidad
      </h1>
      <p className="mt-3 font-mono text-xs tabular-nums text-text-3">
      ...
      <article className="prose prose-invert mt-10 space-y-8 font-body leading-relaxed text-text-2">
        <section>
          <h2 className="font-display text-2xl text-text-1">Quién es responsable</h2>
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Qué guardamos</h2>
          <p className="mt-2 text-pretty">
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Por qué podemos guardarlo</h2>
          <p className="mt-2 text-pretty">
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Quién tiene acceso</h2>
          <p className="mt-2 text-pretty">
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Cuánto tiempo</h2>
          <p className="mt-2 text-pretty">
        ...
        <section>
          <h2 className="font-display text-2xl text-text-1">Tus derechos</h2>
          <p className="mt-2 text-pretty">
